...
response = client.models.generate_content(
    model="gemini-2.5-flash",
    contents=f"""
           These two XML files represent traffic data simulations using SUMO before and after blocking a lane temporarily. Give some context on the simulation first (i.e. how long in hours the simulation was ran in real time, how many cars were used in the simulation etc.). Compare both data outputs and explain what the aggregate,
             ...
             likely to emergency stop, X cars were jammed for Y time until they were removed from the simulation etc.).
             You should not use any formatting in your answer, only return plaintext.
